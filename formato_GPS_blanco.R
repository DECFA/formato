...
# decimales tiene.
#
# Usaremos por convención el ; como separador de campos y el . como separador
# de decimales.
#
...
write.table(vessel_track_sf_final,
  file = "datos_de_muestra/GPS/gps_blanco_formatted_final.csv",
  sep = ";", dec = ".", row.names = FALSE, col.names = TRUE,
  quote = FALSE, na = ""
)
saveRDS(vessel_track_sf_final,
        file = "datos_de_muestra/GPS/gps_blanco_formatted_final.rds")
...
write.table(vessel_track_postgis,
            file = "datos_de_muestra/GPS/gps_blanco_formatted_final_postgis.csv",
            sep = ";", dec = ".", row.names = FALSE, col.names = TRUE,
            quote = FALSE, na = ""
)